      ...
      <div class="row">
          <div class="col-md-3 col-sm-6">
              ...
              <div class="square-effect bg">
                  <img src="/assets/images/fancybox/6-1.png" alt="fancybox">
              </div>
          ...
          <div class="col-md-3 col-sm-6">
              <div class="consult-services xamin-square right wow fadeInUp  text-left" >
              <div class="square-effect bg">
                  <img src="/assets/images/fancybox/6-2.png" alt="fancybox">
              </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="consult-services xamin-square right wow fadeInUp  text-left" >
              <div class="square-effect bg">
                  <img src="/assets/images/fancybox/6-3.png" alt="fancybox">
              </div>
          ...
          <div class="col-md-3 col-sm-6">
            <div class="consult-services   xamin-square wow fadeInUp  text-left" >
              <div class="square-effect bg">
                <img src="/assets/images/fancybox/6-4.png" alt="fancybox">
              </div>
