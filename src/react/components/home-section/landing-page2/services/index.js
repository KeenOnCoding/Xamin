...
class Index extends React.Component {
    constructor(props) {
        ...
        this.state = {
            list: [
                {
                    media: require('../../../../public/assets/images/services/01.png'),
                    title: 'Data Analytics',
                    description: 'It is a long established fact that a reader will be distracted by the of readable content .'
                },
                {
                    media: require('../../../../public/assets/images/services/02.png'),
                    title: 'Managed Analytics',
                    description: 'It is a long established fact that a reader will be distracted by the of readable content .'
                },
                {
                    media: require('../../../../public/assets/images/services/03.png'),
                    title: 'Big Data Services',
                    description: 'It is a long established fact that a reader will be distracted by the of readable content .'
                },
                {
                    media: require('../../../../public/assets/images/services/04.png'),
                    title: 'Data Science',
                    description: 'It is a long established fact that a reader will be distracted by the of readable content .'
                },
                {
                    media: require('../../../../public/assets/images/services/05.png'),
                    title: 'Business Intelligence',
                    description: 'It is a long established fact that a reader will be distracted by the of readable content .'
                },
                {
                    media: require('../../../../public/assets/images/services/06.png'),
