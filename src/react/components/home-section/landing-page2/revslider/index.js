...
import img from "../../../../public/assets/revslider/assets_slider2/dummy.png";
import img1 from "../../../../public/assets/revslider/assets_slider2/transparent.png";
// import img2 from '../../../../public/assets/revslider/assets_slider2/Comp-1_1-converted-with-Clipchamp.mp4'3

import $ from "jquery";

const Index = () => {
  React.useEffect(() => {
    if (!tpj("#rev_slider_1_1").hasClass("revslider-initialised")) {
      $("#rev_slider_1_1")
        .show()
        .revolution({
          sliderType: "standard",
  ...
  return (
    <>
      <div>
        <RevSlider revId={"rev_slider_1_1"}>
          <rs-slide
            data-key="rs-1"
            data-title="Slide"
          ...
          >
            <img
              src={img}
              data-lazyload="./assets/revslider/assets_slider2/transparent.png"
              data-parallax="off"
            ...
            <rs-bgvideo
              ...
              data-mp4="./assets/revslider/assets_slider2/Comp-1_1-converted-with-Clipchamp.mp4"
            ></rs-bgvideo>
            <h2
            ...
            >
              Sigma collects data, transform it for analysis, runs
              <br /> analytical algorithms, and prepare visualizations.
            </rs-layer>
            <rs-layer
