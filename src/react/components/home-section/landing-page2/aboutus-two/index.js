                    ...
                    props.items.map((item,index) => (
                        <div key={index} className={item.className}>
                            <div className="tec_icon">
                                <Image src={item.image} alt="tecbox" />
                            </div>
                        </div>
                    ))
                }
...
class Index extends React.Component {
            ...
            tecIcon:[
                {
                    ...
                    image:require("../../../../public/assets/images/services/services-small-1.png")
                },
                {
                    className:'img_icon_two',
                    image:require("../../../../public/assets/images/services/services-small-2.png")
                },
                {
                    className:'img_icon_three',
                    image:require("../../../../public/assets/images/services/services-small-3.png")
                }
            ]
        }
    }
    ...
    render() {
        ...
        return (
            <>
                <AboutStyle2 img={img} className={"iq-bg-over"}>
