...
import img from  "../../../../public/assets/images/services/13.png"
import img1 from  "../../../../public/assets/images/services/14.png"
import img2 from  "../../../../public/assets/images/services/13.png"
import img3 from  "../../../../public/assets/images/services/14.png"
            ...
            cardData: [
                {
                    ...
                    img: require("../../../../public/assets/images/services/6-1.png"),
                ...
                },
                {
                    ...
                    img: require("../../../../public/assets/images/services/6-2.png"),
                    text:"It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout."
                ...
                },
                {
                    ...
                    img: require("../../../../public/assets/images/services/6-3.png"),
                    text:"It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout."
                },
                {
                    ...
                    img: require("../../../../public/assets/images/services/6-4.png"),
                    text:"It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout."
                        ...
                        <div className="col-md-6 tab-content">
                            <div id="tab-software-development" className="tab-pane fade active show">
                                <div className="xamin-right-img-wm">
                                    <Image width="863" height="528" src={img} className="attachment-full"  sizes="100vw" />
                                </div>
                        </div>
                        <div id="tab-application-services" className="tab-pane fade">
                            <div className=" xamin-right-img-wm">
                                    <Image width="863" height="528" src={img1} className="attachment-full"  sizes="100vw" />
                            </div>
                        </div>
                        <div id="tab-data-analytics" className="tab-pane fade">
                            <div className=" xamin-right-img-wm">
                                    <Image width="863" height="528" src={img2} className="attachment-full"  sizes="100vw" />
                            </div>
                        </div>
                        <div id="tab-help-desk-services" className="tab-pane fade">
                            <div className=" xamin-right-img-wm">
                                    <Image width="863" height="528" src={img3} className="attachment-full"  sizes="100vw" />
                            </div>
                        </div>
                    </div>
