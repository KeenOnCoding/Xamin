...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            items:[
                {
                    media: require("../../../../public/assets/images/fancybox/6-1.png"),
                    title: "Generate Ideas",
                    text :"It is a long established fact that a fre ader will be distracted by the "

                },
                {
                    media: require("../../../../public/assets/images/fancybox/6-2.png"),
                    title: "Collect Data",
                    text :"it is a long established fact that a reader will be distracted by the of readable"
                },
                {
                    media: require("../../../../public/assets/images/fancybox/6-3.png"),
                    title: "Create Design",
                    text :"it is a long established fact that a reader will be distracted by the of readable"
                },
            
                {
                    media: require("../../../../public/assets/images/fancybox/6-4.png"),
