...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            cardData: [
                {
                    img: require("../../../../public/assets/images/fancybox/4.png"),
                    value:"455",
                    text:"Managed Analytics as a global business"
                },
                {
                    img: require("../../../../public/assets/images/fancybox/3.png"),
                    value:"32",
                    text:" Data Management in the telecoms"
                },
                {
                    img: require("../../../../public/assets/images/fancybox/2.png"),
                    value:"1254",
                    text:"Managed Analytics in business"
                },
                {
                    img: require("../../../../public/assets/images/fancybox/1.png"),
                    value:"563",
