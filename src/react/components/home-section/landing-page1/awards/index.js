    ...
    return cardList.map((card, index) => (
        <div key={index}  className="col-md-3">
            <div className="xamin-award wow fadeInUp  text-center">
                <div className="award-img"> <Image src={card.img} alt='award-imgs'/> </div>
...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            cardData: [
                {
                    img:  require('../../../../public/assets/images/awards/1.png'),
                    desc: "Microsoft Partner of the Year Award",
                },
                {
                    img:  require('../../../../public/assets/images/awards/2.png'),
                    desc: "Global Sourcing Awards 2018 Finalist",
                },
                {
                    img:  require('../../../../public/assets/images/awards/4.png'),
                    desc: "Gold Winner of 2013 Horizon Awards",
                },  
                {
                    img:  require('../../../../public/assets/images/awards/3.png'),
                    desc: "European Software Testing Awards Finalist",
                },
                {
                    img:  require('../../../../public/assets/images/awards/5.png'),
                    desc: "Microsoft Partner of the Year Award",
                },
                {
                    img:  require('../../../../public/assets/images/awards/3.png'),
