                ...
                tabs: [
                    {
                        ...
                        title: 'Big Data',
                        active: true,
                        img: require('../../../../public/assets/images/services/03.png')
                    },
                    {
                        id: 'machine-learning',
                        ...
                        active: false,
                        img: require('../../../../public/assets/images/services/02.png')
                    },
                    {
                        id: 'analytical-ai',
                        ...
                        title: 'Analytical AI',
                        active: false,
                        img: require('../../../../public/assets/images/services/01.png')
                    },
                    {
                        id: 'computer-vision',
                        ...
                        active: false,
                        img: require('../../../../public/assets/images/services/04.png')
                    },
                                        ...
                                        <div className="show_content">
                                                ...
                                                <div className="row pl-lg-5 pr-lg-5">
                                                    <div className="col-sm-12">
                                                        <div className=" text-left mt-4 ">
                                                            <Link href="/services">
                                                                <span className="button button-icon" ><span className="btn-effect"> View all Services</span></span>
                                                            </Link>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="row pl-lg-5 pr-lg-5">
                                                    <div className="col-sm-6">
                                                        ...
                                                        <div className=" text-left mt-4 mb-lg-0 mb-md-0 mb-4 ">
                                                            <Link href="/services">
                                                                <span className="button button-icon" ><span className="btn-effect"> Read More</span></span>
                                                            </Link>
                                                        </div>
                                                    </div>
                                                    <div className="col-sm-6">
                                            ...
                                            <div id="tab-analytical-ai" className="tab-pane fade">
                                                ...
                                                <div className="row pl-lg-5 pr-lg-5">
                                                    <div className="col-sm-12">
                                                        <div className=" text-left mt-4 ">
                                                            <Link href="/services"><span className="button button-icon" ><span className="btn-effect"> View all Services</span></span></Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="tab-computer-vision" className="tab-pane fade">
                                                <div className="row pl-lg-5 pr-lg-5">
                                                    <div className="col-sm-6">
                                                        ...
                                                        <div className=" text-left mt-4 mb-lg-0 mb-md-0 mb-4 "> <Link className="button button-icon" href="/services"><span className="btn-effect"> Read More</span></Link></div>
                                                    </div>
                                                    <div className="col-sm-6">
                                                        <h4 className="custom_heading mb-3">Dignissimos ducimus qui blanditiis</h4>
                                                        <CheckboxList items={checklist} text={"text-left"} />
