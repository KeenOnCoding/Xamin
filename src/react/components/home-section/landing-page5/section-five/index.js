...
class   Index extends React.Component {
    constructor(props) {
        ...
        this.state={
           cardData:[
                {
                    img: require("../../../../public/assets/images/facybox/5-1.png"),
                    value:50,
                    heading:"Tranding Volumn"
                },
                {
                    img: require("../../../../public/assets/images/facybox/5-2.png"),
                    value:50,
                    heading:"Tranding Volumn"
                },

                {
                    img: require("../../../../public/assets/images/facybox/5-3.png"),
                    value:50,
                    heading:"Tranding Volumn"
                },
                {
                    img: require("../../../../public/assets/images/facybox/5-4.png"),
                    value:50,
                    heading:"Tranding Volumn"
                },
           ],
