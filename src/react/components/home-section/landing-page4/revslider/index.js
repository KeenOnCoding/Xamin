...
import img from "../../../../public/assets/revslider/assets_silder5/dummy.png";
import img1 from "../../../../public/assets/revslider/assets_silder5/dummy.png";
import img2 from "../../../../public/assets/revslider/assets_silder5/dummy.png";
import img3 from "../../../../public/assets/revslider/assets_silder5/dummy.png";
import img4 from "../../../../public/assets/revslider/assets_silder5/dummy.png";
const Index = () => {
  React.useEffect(() => {
    if (!tpj("#rev_slider_4_1").hasClass("revslider-initialised")) {
      $("#rev_slider_4_1")
        .show()
        .revolution({
          sliderType: "standard",
  ...
  return (
    <>
      <div>
        <RevSlider revId={"rev_slider_4_1"}>
          <rs-slide
            data-key="rs-4"
            data-title="Slide"
          ...
          >
            <Image
              src={img}
              data-lazyload="./assets/revslider/assets_silder5/transparent.png"
              data-bg="c:#f9f9fe;"
              data-parallax="off"
            ...
            >
              <Image
                ...
                width="911"
                height="516"
                data-lazyload="./assets/revslider/assets_silder5/bannershap.png"
                data-no-retina
              />
            </rs-layer>
            <rs-layer
            ...
            >
              <Image
                ...
                width="61"
                height="61"
                data-lazyload="./assets/revslider/assets_silder5/tooltip.png"
                data-no-retina
              />
            </rs-layer>
            <rs-layer
            ...
            >
              <Image
                ...
                width="916"
                height="916"
                data-lazyload="./assets/revslider/assets_silder5/bannercircle.png"
                data-no-retina
              />
            </rs-layer>
            <rs-layer
