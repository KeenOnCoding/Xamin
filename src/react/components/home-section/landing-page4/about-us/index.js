...
import img from "../../../../public/assets/images/about-us/11.png"
        ...
        return (
            <>
                    <section className="position-relative overflow-hidden">
                         <Image src={img} className="about-right-box-img" alt="" />
                        ...
                        <div className="row">
                            <div className="col-lg-6 wow fadeInUp align-items-center">
                                ...
                                <div className=" text-left mt-5 ">
                                    <Link className="button button-icon" href="about-us.html"> <span className="btn-effect"> Get Started Project</span> </Link>
                                </div>
                            </div>
