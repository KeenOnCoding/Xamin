...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            items:[
                {
                    media: require("../../../../public/assets/images/services/07.png"),
                    title: "User Behavior",
                ...
                {
                    media: require("../../../../public/assets/images/services/08.png"),
                ...
                {
                    media: require("../../../../public/assets/images/services/09.png"),
