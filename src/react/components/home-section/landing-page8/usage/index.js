...
import img2 from "../../../../public/assets/images/about-us/13.png"
import img3 from "../../../../public/assets/images/about-us/13.png"
import img4 from "../../../../public/assets/images/about-us/13.png"
...
const List = (props) => {
    ...
    const list = listItems.map((item, index) => (
        <li key={index} className="nav-item">
            ...
            >
                <Image src={item.img} alt="tab-image" className="img-fluid" />
...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            tabs: [
                {
                    img:  require("../../../../public/assets/images/usage/5.png"),
                    title:"Collect Data",
                ...
                {
                    img:  require("../../../../public/assets/images/usage/4.png"),
                ...
                {
                    img:  require("../../../../public/assets/images/usage/3.png"),
                    title:"Understand",
                    href: 'tab-understand',
                    active: false,
                ...
                {
                    img:  require("../../../../public/assets/images/usage/2.png"),
                ...
                {
                    img:  require("../../../../public/assets/images/usage/1.png"),
                    title:"Take Action",
            ...
            image:[
                "../../../../public/assets/images/about-us/13.png"
            ]
                                ...
                                <div className="custom-tab-userbehavior text-left mt-md-5">
                                    ...
                                    <div className="tab-content">
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        ...
                                                        <div className=" text-left mt-5 ">
                                                              <Link className="button button-icon" href="#"><span className="btn-effect"> View Details</span></Link>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6 mt-5 mt-md-0">         
                                                        <Image width="562" height="532" src={img} className="attachment-full" alt="" sizes="100vw" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="tab-identifytrends" className="tab-pane fade">
                                                <div className="row">
                                                     <div className="col-md-6">         
                                                        <Image width="562" height="532" src={img1} className="attachment-full" alt="" sizes="100vw" />
                                                    </div>
                                                    <div className="col-md-6">
                                                        <SectionTitle 
                                                            link="02"
                                            ...
                                            <div id="tab-understand" className="tab-pane fade">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6 mt-5 mt-md-0">         
                                                        <Image width="562" height="532" src={img2} className="attachment-full" alt="" sizes="100vw" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="tab-goals-hypotheses" className="tab-pane fade">
                                                <div className="row">
                                                        <div className="col-md-6">         
                                                            <Image width="562" height="532" src={img3} className="attachment-full" alt="" sizes="100vw" />
                                                        </div>
                                                        <div className="col-md-6">
                                                            <SectionTitle 
                                                                link="04"
                                            ...
                                            <div id="tab-take-action" className="tab-pane fade">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6 mt-5 mt-md-0">         
                                                        <Image width="562" height="532" src={img4} className="attachment-full" alt="" sizes="100vw" />
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
