...
class Index extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            cardData: [
                {
                    images:  require("../../../../public/assets/images/services/02.png"),
                    name: "Big Data Consulting",
                    description: "Many variation established fact reader will be distracted by the of readable content . ",
                },
                {
                    images:  require("../../../../public/assets/images/services/03.png"),
                    name: "Machine Learning",
                    description: "Many variation established fact reader will be distracted by the of readable content . ",
                },
                {
                    images:  require("../../../../public/assets/images/services/04.png"),
