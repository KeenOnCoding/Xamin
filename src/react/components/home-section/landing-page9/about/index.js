...
import img from "../../../../public/assets/images/about-us/19.png"
                  ...
                  <div className="container">
                      <div className="row">
                          <div className="col-lg-5 col-md-5 col-sm-12">
                              <Image width="537" height="750" src={img} className="attachment-full" alt="about-us"  sizes="100vw" />
                          </div>
                          <div className="col-lg-7 col-md-7 col-sm-12">
                                ...
                                <div className=" text-left  "><Link className="button blue-btn button-icon" href="#"><span className="btn-effect"> Download CV</span></Link></div>
                          </div>
                      </div>
