...
import img from "../../../../public/assets/revslider/assets_slider9/transparent.png";
import img1 from "../../../../public/assets/revslider/assets_slider9/xamin-d9-banner-img.png";
import img2 from "../../../../public/assets/revslider/assets_slider9/xamin-d9-eclippse2.png";
import img3 from "../../../../public/assets/revslider/assets_slider9/xamin-d9-eclippse1.png";

const Index = () => {
  React.useEffect(() => {
    if (!tpj("#rev_slider_9_1").hasClass("revslider-initialised")) {
      $("#rev_slider_9_1")
        .show()
        .revolution({
          sliderType: "standard",
  ...
  return (
    <>
      <div>
        <RevSlider revId={"rev_slider_9_1"}>
          <rs-slide
            data-key="rs-5"
            data-title="Slide"
          ...
          >
            ...
            >
              <Image src={img1} width="600" height="687" data-no-retina />
            </rs-layer>
            <rs-layer
            ...
            >
              <Image src={img2} width="157" height="365" data-no-retina />
            </rs-layer>
            <rs-layer
            ...
            >
              <Image src={img3} width="365" height="158" data-no-retina />
            </rs-layer>
            <h1
