                              ...
                              <div className="active-faq clearfix">
                                 <div className="container">
                                    <div className="row align-items-center">
                                       <div className="col-md-9 col-sm-12 "> <Link href="#" className="accordion-title"><span>{props.title}</span></Link> </div>
                                       <div className="col-md-3 col-sm-12 text-center text-lg-right text-md-right"> <Link className="button" href="#">Apply Now</Link> </div>
                                    </div>
                                 </div>
                              </div>
