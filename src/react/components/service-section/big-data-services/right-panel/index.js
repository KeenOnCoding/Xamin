...
class Index extends React.Component {
    constructor(props) {
        ...
        this.state={
            owlData:[
                {
                    img: require("../../../../public/assets/images/about-us/03.png"),
                ...
                {
                    img: require("../../../../public/assets/images/about-us/05.png"),
                    text : "It is a long established",
                    ...
                    <div className="row iq-pb-45">
                        ...
                        >
                                     { this.state.owlData.map((item, index) => (
                                                ...
                                                >
                                                    <Link href=""><i aria-hidden="true" className="fa fa-plus"></i></Link>
                                                </Carousel2>
                                        )) }
                        </div>
                    </div>
