...
import img from "../../../../public/assets/images/about-us/02.png"
import img1 from "../../../../public/assets/images/about-us/03.png"
...
class Index extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            cardData1: [
                {
                    img:  require('../../../../public/assets/images/testimonials/3.jpg'),
                    name: "Mark McManus",
                    position: "COO",
                ...
                {
                    img:  require('../../../../public/assets/images/testimonials/2.jpg'),
                    name: "Jack White",
                    position: "CEO",
                    desc: "“Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.” ",
                },
                                ...
                                <div className="col-lg-8 col-sm-12">
                                        ...
                                        { cardData.map((item, index) => ( 
                                            ...
                                            >
                                                ...
                                                <div className="row ">
                                                    <div className="col-lg-6 col-md-6 col-sm-12 mb-5 mt-3"><Image src={img} alt="images" /></div>
                                                    <div className="col-lg-6 col-md-6 col-sm-12 mb-5 mt-3"><Image src={img1} alt="images" /></div>
                                                </div>
