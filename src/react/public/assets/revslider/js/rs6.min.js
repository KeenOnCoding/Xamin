    ...
    e.fn.extend({
      ...
      e.extend(!0, i, {
        ...
        setSize: function (a, r) {
          var o,
            s =
              parseInt(i[a].top_outer || 0) + parseInt(i[a].bottom_outer || 0),
            n =
          ...
          if (
            ...
            i[a].fullScreenOffset.split("%").length > 1
              ? (f -=
                  (e(window).height() * parseInt(i[a].fullScreenOffset, 0)) /
                  100)
              : i[a].fullScreenOffset != t &&
          ...
          if (i[a].smiddleZones && i[a].smiddleZones.length > 0)
            for (o = 0; o < i[a].smiddleZones.length; o++)
              i[a].smiddleZones[o].style.top =
                Math.round(b / 2 - i[a].smiddleZones[o].offsetHeight / 2) +
                "px";
          y(a);
        },
    ...
    var a = i.is_mobile(),
                  ...
                  '<rs-layer class="rs-layer slidelink" style="z-index:' +
                    ...
                    ("no" == w
                      ...
                      : "  data-actions='" +
                        ...
                        "'") +
                    " data-frame_1='e:Power3.easeInOut;st:100;sp:100' data-frame_999='e:Power3.easeInOut;o:0;st:w;sp:100'><Link " +
                    ("slide" != y
                      ? ' target="' +
          ...
          if (
            ...
            if (isNaN(R) || R < 6)
              ...
              for (
                ...
                A > 0 && (C += " "),
                  (C += '<span style="background:' + O + '"></span>');
              (C += "</div>"),
                (i[r].loader = e(
                  '<rs-loader class="' +
                    i[r].spinner +
      ...
      g = function (a) {
          ...
          ("fullscreen" === i[a].sliderLayout &&
            ...
            : punchgs.TweenMax.set(i[a].cpar, {
                left:
                  ...
                  "px",
                width:
                  e(window).width() - i.getHorizontalOffset(i[a].c, "both"),
              }),
          "auto" === i[a].sliderLayout &&
            i[a].modal !== t &&
        ...
        i[a].slayers &&
          "fullwidth" != i[a].sliderLayout &&
          "fullscreen" != i[a].sliderLayout &&
          punchgs.TweenMax.set(i[a].slayers, {
            left: r,
          });
      },
      f = function (a, r) {
          ...
          if (
            ...
            !0 === i[a].onlyPreparedSlide && (i[a].onlyPreparedSlide = !1),
              ...
              i[a].pr_next_slide !== t &&
                ...
                (i[a].pr_next_slide[0].dataset.sofacounter =
                  i[a].pr_next_slide[0].dataset.sofacounter == t
                    ? 1
                    : parseInt(i[a].pr_next_slide[0].dataset.sofacounter, 0) +
                      1),
              i[a].stopLoop &&
                i[a].pr_processing_key == i[a].lastslidetoshow - 1 &&
                (i[a].c.find("rs-progress").css({
                  visibility: "hidden",
                }),
              ...
              S(i[a].pr_next_slide[0], a, function () {
                if (i[a] !== undefined && i[a].pr_next_slide !== undefined) {
                  // Your code here
                  i[a] !== t &&
          ...
          !_R[e].moduleActionsPrepared &&
            ...
            (_R[e].c.on("tp-mouseenter", function () {
              ...
              if ("none" !== i && i !== undefined) {
                if (
                  (i = _R[e].slides[i].dataset.key) !== undefined &&
                  _R[e].layers[i]
                )
              ...
              if (
                ...
                if (o.vary_fade)
                  h.autoAlpha =
                    1 -
                    Math.abs(
                      (o.maxOpacity / 100 / Math.ceil(o.maxVisibleItems / f)) *
                        g
                    );
                else
              ...
              void 0 !== o.minScale &&
                ...
                (o.vary_scale
                  ? (h.scale =
                      1 -
                      Math.abs(
                        (o.minScale / 100 / Math.ceil(o.maxVisibleItems / f)) *
                          g
                      ))
                  : (h.scale =
                      g >= 1 || g <= -1
            ...
            if (i[o].layers[s].hasOwnProperty(n)) {
              var l =
                  "carousel" === i[o].sliderType
                    ? 0
                    : i[o].width / 2 -
                      (i[o].gridwidth[i[o].level] * i[o].bw) / 2,
                d = 0,
                c = i[o].layers[s][n],
                h = jQuery(c),
                ...
                if (
                  ...
                  (g._column =
                    "RS-COLUMN" === h[0].tagName
                      ...
                      : "none"),
                  (g._row =
                    "RS-COLUMN" === h[0].tagName && h.closest("rs-row")),
                  ...
                  (g._isstatic =
                    h[0].className.indexOf("rs-layer-static") >= 0),
                ...
                "slide" !== g.basealign &&
                  ...
                  (l = Math.max(
                    ...
                    "center" === i[o].carousel.horizontal_align
                      ? 0 +
                          (i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw) / 2
                  ...
                  if (
                    ...
                    -1 != h[0].className.indexOf("rs-fsv") || S
                      ...
                      : punchgs.TweenMax.set(h, {
                          ...
                          paddingLeft:
                            Math.round(C.paddingLeft * i[o].bw) + "px",
                          paddingRight:
                      ...
                      ((0 == g.html5vid && !S) ||
                        ...
                        (g.media.width(M), g.media.height(O)),
                      g._ingroup &&
                        null != M &&
                        !jQuery.isNumeric(M) &&
                        M.indexOf("%") > 0 &&
                ...
                if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                  ...
                  if (
                    ...
                    var S = u.frames[I],
                      ...
                      j =
                        void 0 !== S.sfx &&
                        g(S.sfx.effect, u.m, S.timeline.ease),
            ...
            var a = i[t].level,
              ...
              o = {
                basealign:
                  void 0 ===
                  (r =
                    void 0 === r.basealign ? e.closest("rs-layer").data() : r)
                    .basealign
                    ? "grid"
                    : r.basealign,
                lineHeight:
      ...
      var r = function (e, i) {
        ...
        o = function (e, t, i, a, r, o) {
          var s = i.parent().find(".tp-" + o + "s"),
            ...
            l = s.find(".tp-" + o + "-mask"),
            d =
              a.width * e < a.min_width ? a.min_width : Math.round(a.width * e),
                ...
                "vertical" === a.direction
                  ? t.add(
                      punchgs.TweenLite.set(i, {
                        top:
                          e *
                          (c + parseInt(void 0 === a.space ? 0 : a.space, 0)),
                        width: d + "px",
                        height: c + "px",
                      })
                    )
                  : "horizontal" === a.direction &&
                    t.add(
                      punchgs.TweenLite.set(i, {
                        left:
                          e *
                          (d + parseInt(void 0 === a.space ? 0 : a.space, 0)),
                        width: d + "px",
                        height: c + "px",
                      })
                    );
                    ...
                    case "move":
                      ...
                      (O =
                        O < C
                          ? "horizontal" === R
                            ? O +
                              (((L.width() * (O - C)) / L.width()) * (O - C)) /
                                L.width()
                            : O +
                              (((L.height() * (O - C)) / L.height()) *
                                (O - C)) /
                                L.height()
                          : O),
                        "vertical" === R
            ...
            ("mouse" != a.type &&
              ...
              (t[e].c.mouseenter(function (i) {
                var a = t[e].c.offset().top,
                  r = t[e].c.offset().left;
                void 0 !== t[e].pr_active_key &&
                  ((t[e].slides[t[e].pr_active_key].dataset.enterx =
                    i.pageX - r),
                  (t[e].slides[t[e].pr_active_key].dataset.entery =
                    i.pageY - a));
              }),
              t[e].c.on(
          ...
          if (void 0 !== t[e]) {
            ...
            var c =
              ...
              p = t[e].fixedOnTop
                ? Math.min(
                    1,
                    Math.max(0, window.scrollY / t[e].lastwindowheight)
                  )
                : Math.min(
                    1,
                    Math.max(
                      ...
                      1 -
                        (s.top + s.hheight) /
                          (s.hheight + t[e].lastwindowheight)
                    )
                  ),
              u =
        ...
        a = function (e) {
          ...
          if (
            ...
            (V[G] = "0px"),
              ...
              t[a].mtl.add(
                punchgs.TweenLite.fromTo(t[a].pr_active_bg, d / 1e3, V, Y),
                0
              ),
              t[a].mtl.add(
                punchgs.TweenLite.fromTo(
              ...
              t[a].mtl.add(punchgs.TweenLite.fromTo(Q, d / 1e3, X, Z), 0),
              t[a].mtl.add(
                punchgs.TweenLite.fromTo(
          ...
          switch (o.type) {
            ...
            case "vimeo":
              o.volcachecheck ||
                ...
                (o.volcachecheck = !0)),
                (o.volume =
                  !0 === a ? "mute" : !1 === a ? o.volcache : o.volume),
                void 0 !== a &&
                  null != o.vimeoplayer &&
                ...
                if (
                  ...
                  L
                    ...
                    : (n.aplay || "true" === n.aplay) &&
                      (k && (n.aplay = !1), (x = !0)),
                    x && (n.vimeoplayer.setVolume(0), (n.volume = "mute"));
